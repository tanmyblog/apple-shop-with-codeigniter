<html>
<head>
    <title><?php echo $categories->name ?></title>
    <?php
$e = array(
...
meta_tags($e, $title = ''.$categories->name, $desc = ''.$categories->meta_desc, $imgurl = '', $url = '');
?>
    <link rel="shortcut icon" href="<?php echo base_url(); ?>favicon.ico">
    <meta name='keywords' content='<?php echo $categories->meta_key; ?>' />
        ...
        <div class="container">
            ...
            <div class="col-md-9 product-w3ls-right">
                ...
                <div class="product-top">
                    <h4><?php echo $categories->name; echo '&nbsp - &nbsp'; echo $total_rows; ?> sản phẩm </h4>
                    <ul> 
