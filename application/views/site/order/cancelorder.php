...
meta_tags($e, $title = 'Hủy thanh toán', $desc = 'Bạn đã hủy thanh toán trực tuyến hãy liên hệ với quản trị viên để biết thêm thông tin', $imgurl = '', $url = '');
?>
        ...
        <div class="container">
            ...
            <div class="col-md-9 product-w3ls-right">
                ...
                <ol class="breadcrumb breadcrumb1">
                    ...
                    <li class="active">Hủy thanh toán</li>
                </ol> 
                ...
                <div class="products-row">
					<div class="alert alert-danger">
						<h3>Giao dịch không thành công! </h3>	
					</div>
					<h4>Quay về <a href="<?= base_url(); ?>">Trang chủ</a></h4>
                </div>
            </div>
            <!-- end main content -->
