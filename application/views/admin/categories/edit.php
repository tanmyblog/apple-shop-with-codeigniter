                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " method="post" action="">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="name" name="name" type="text" value="<?php echo $info->name;?>" placeholder="Nhập tên danh mục"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="site_title" name="site_title" type="text" value="<?php echo $info->site_title; ?>" placeholder="Tiêu đề seo sẽ động get từ tên danh mục"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="meta_desc" name="meta_desc" type="text" value="<?php echo $info->meta_desc; ?>" placeholder="Nhập mô tả seo" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="meta_key" name="meta_key" type="text" value="<?php echo $info->meta_key; ?>" placeholder="Nhập từ khóa seo"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="sort_order" name="sort_order" type="text" value="<?php echo $info->sort_order; ?>" placeholder="chọn thứ tự hiển thị"/>
