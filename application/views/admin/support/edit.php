                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " method="post" action="">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="name" name="name" type="text" value="<?php echo $info->name; ?>" placeholder="Nhập tên người hỗ trợ" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="gmail" name="gmail" type="email" value="<?php echo $info->gmail; ?>" placeholder="Nhập gmail"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="facebook" name="facebook" type="text" value="<?php echo $info->facebook; ?>" placeholder="Nhập facebook" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="phone" name="phone" type="number" value="<?php echo $info->phone; ?>" placeholder="Nhập số điện thoại"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="sort_order" name="sort_order" type="number" value="<?php echo $info->sort_order; ?>" placeholder="chọn thứ tự hiển thị"/>
