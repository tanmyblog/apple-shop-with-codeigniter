...
class Nganluong_payment
{
	...
	function payment($name, $email, $phone, $address, $payment_mt, $bankcode,$total_price){
		define('URL_API','https://www.nganluong.vn/checkout.api.nganluong.post.php'); // Đường dẫn gọi api
		define('RECEIVER','kd.aigapa@gmail.com'); // Email tài khoản ngân lượng
		define('MERCHANT_ID', '54832'); // Mã merchant kết nối
		define('MERCHANT_PASS', '8101ef0e90f369b527891aa1b447375a'); // Mật khẩu kết nôi
		...
		$tax_amount=0;
		$fee_shipping=0;
		$return_url =''.base_url('thanh-toan-thanh-cong');
		$cancel_url =urlencode(base_url('huy-thanh-toan'));
